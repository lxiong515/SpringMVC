...
//public class SpringContacts1Application implements CommandLineRunner{
public class SpringContacts1Application {

	public static void main(String[] args) {
		SpringApplication.run(SpringContacts1Application.class, args);
